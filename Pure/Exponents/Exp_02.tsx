...
export default function ExponentAnimator() {
  ...
  // Determine if result is positive or negative for styling
        ...
        {base && exponent && (
          <div className="space-y-8">
            ...
            <div className={`bg-gradient-to-r ${
              isResultPositive ? 'from-green-50 to-emerald-50' : 'from-red-50 to-rose-50'
              ...
              <div className="text-sm text-gray-500 mt-2">
                {exponent % 2 === 0 ? 'Even power → Positive' : 'Odd power → Negative'}
              </div>
            </div>
          </div>
        )}
